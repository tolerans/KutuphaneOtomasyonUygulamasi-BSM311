...
namespace KitapProjesiKardes.Controllers
{
    public class KitaplarsController : Controller
    {
        ...
        {
            return View(db.Kitaplars.ToList());
        }
        ...
        public ActionResult Create([Bind(Include = "KitapID,ISBN,DemirBasNO,KitapAdi,Dil,Konu,YerNO")] Kitaplar kitaplar)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "KitapID,ISBN,DemirBasNO,KitapAdi,Dil,Konu,YerNO")] Kitaplar kitaplar)
        {
            if (ModelState.IsValid)
            {
